...
<div style="font-size: 1.1em; line-height: 1.8; color: #333; text-align: center;">
    ...
    <p style="font-size: 1.5em; font-weight: bold; color: #1a365d; margin: 15px 0;">UNIVERSITY OF EXCELLENCE</p>
...
<div style="margin-top: 40px; display: flex; justify-content: space-between; align-items: flex-end;">
    ...
    <div style="text-align: right;">
      <div style="border-top: 1px solid #000; width: 200px; padding-top: 5px; font-style: italic;">Dr. Heather Perfetti</div>
...
<div data-verify-line="accred" style="border-top: 1px dashed #999; margin-top: 40px; padding-top: 10px; font-family: 'Courier New', monospace; font-size: 0.75em; color: #555; text-align: center;"
      ...
      <span data-verify-line="accred">verify:msche.org/v</span> <span verifiable-text="end" data-for="accred"></span>
  </div>
</div>
...
Shows the issuer domain (`msche.org`, `hlcommission.org`) and current standing.

**Status Indications:**
- **Accredited** — Institution meets all standards and is in good standing.
- **Probation** — **ALERT:** Significant deficiencies found; status at risk.
