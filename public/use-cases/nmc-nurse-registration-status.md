...
**"Why would you bother?"** In a permanent hospital role, the trust sits with the employer — the NHS trust checks registration at hiring and monitors it thereafter. The gap is agency and locum nursing, where a nurse may arrive on a ward at the start of a shift having been booked hours earlier. Nursing agencies are a documented fraud vector: agencies under pressure to fill shifts have sent staff whose registration has lapsed, who are subject to practice conditions, or who have been struck off entirely. A struck-off nurse who harmed patients and was removed from the register can register with a new agency that fails to check. The consequences are not administrative — they are patient safety failures: medication errors, missed deterioration, clinical harm by someone who should not be practising. Verification at the point of care — when the nurse arrives on the ward — is the last check before patient contact begins.
